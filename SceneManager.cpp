...
bool SceneManager::FindMaterial(/*std::string*/const std::string& tag, OBJECT_MATERIAL& material)
{
...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		"textures/PoolTableTopSeamlessTexture.jpg", "TableTop"
	);

	bReturn = CreateGLTexture(
		"textures/SeamlessDarkWoodTexture.jpg", "Wood"
	);
...
void SceneManager::SetupSceneLights()
{
	...
	// light 3 properties (explicitly turned off to prevent driver garbage/NaNs)
...
void SceneManager::RenderScene()
{
	...
	scaleXYZ = glm::vec3(7.5f, 0.3f, 4.0f);
	...
	// sets the mech for the 3D Shape
	...
	// Pool Cue Tip
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.02f, 0.09f, 0.02f);

	// set the XYZ rotation for the mesh
	XrotationDegrees = 0.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 83.0f;

	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-0.2f, 7.7f, 3.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(5.5f, 7.0f, 3.0f);
	...
	// sets color of the mesh
	SetShaderColor(0.04, 0.1, 0.1, 1);

	// add material to this mesh
	...
	// Pool Cue Shaft
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(.05f, 2.9f, 0.05f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(2.55f, 7.36f, 3.0f);
	...
	// sets color of the mesh
	SetShaderColor(0.90, 0.81, 0.51, 1);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(8.0f, 7.0f, 3.0f);
	...
	/****************************************************************/
		// Top Pool table barrier
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.0f, 17.0f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 11.5f, 3.0f);
